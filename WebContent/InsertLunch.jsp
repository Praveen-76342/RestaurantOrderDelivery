...
%>	
<br/><br/><br/><br/>
<form onsubmit="return valid()" autocomplete="off" name="InsLun" action="InsertLunch" method="post" class="form">
Name <input type="text" name="lname" id="lname" autocomplete="off" /><br>
