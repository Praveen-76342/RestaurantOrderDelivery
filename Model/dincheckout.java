...
/**
 * Servlet implementation class dincheckout
 */
@WebServlet("/dincheckout")
public class dincheckout extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			for(int i=0;i<names.length;i++)
			{
				...
				String sql="Select cost from dinner where diname=?";
